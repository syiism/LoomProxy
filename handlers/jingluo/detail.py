...
from utils.fq_utils import TZ_SHANGHAI, _detect_book_type, book_type_code, normalize_api_base
...
class JingluoDetailHandler(DetailBaseHandler):
    path = "/jingluo/detail"
    name = "jingluo_detail"
    methods = ["GET"]
    query_params = ["base_url", "book_id"]
    description = "番茄（鲸落）详情"
